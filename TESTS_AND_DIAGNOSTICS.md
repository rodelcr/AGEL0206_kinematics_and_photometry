...
**Headline (NEW `_mtwdo_` + bad-pixel mask + Balmer-unmasked + He I 3819 mask + M10 full sky-line audit + M11 cube-matched systematic re-derivation, wide arc-masked window):**
σ_e(<R_e) = **270 ± 12 km/s** = 269.62 ± 11.77 km/s
(stat ±5 ⊕ I-shape ±2.27 ⊕ mask ±6.65 ⊕ frame ±5 ⊕ centering ±4 ⊕ window ±3.82 **⊕ reduction ±3.45**)
Asymmetric form: 269.62 −11.98 / +11.57 km/s.
